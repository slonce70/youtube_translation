...
- `~/Documents/Work/youtube_translation/frontend/src/app/globals.css` (2942 lines — token block + 3 languages to collapse)
- `~/Documents/Work/youtube_translation/frontend/tailwind.config.js` (colors/shadow/animation rewire)
- `~/Documents/Work/youtube_translation/frontend/src/app/layout.tsx` (font wiring — drop serif/Manrope in-app)
- `~/Documents/Work/youtube_translation/frontend/src/components/layout/{Sidebar,Topbar,DashboardShell}.tsx` (shell)
- `~/Documents/Work/youtube_translation/frontend/src/app/dashboard/streaming/page.tsx` (933) + `components/{StreamsList,StreamBuilderModal,LiveEditorModal}.tsx`
- `~/Documents/Work/youtube_translation/frontend/src/app/dashboard/library/page.tsx` (1229) + `src/components/upload/UploadModal.tsx` (1178)
- `~/Documents/Work/youtube_translation/frontend/src/components/streaming/{Sparkline,NowPlayingPanel,LiveStreamHero,StatusStrip,HeroTile}.tsx` (wedge components)
- `~/Documents/Work/youtube_translation/frontend/src/components/ui/{Button,Badge,LiveDot,CommandPalette,Modal}.tsx` + new `DataState.tsx` (primitives)
