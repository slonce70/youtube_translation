...
import { RadioTower, Music, Youtube, Twitch } from 'lucide-react'
...
import { StreamBuilderSummaryRail } from './StreamBuilderSummaryRail'
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/70 px-4 py-6 backdrop-blur-sm">
      <div className="mx-auto flex w-full max-w-7xl gap-6 overflow-visible max-lg:flex-col lg:max-h-[calc(100vh-3rem)]">
        <Card className="flex-1 overflow-y-auto lg:max-h-[calc(100vh-3rem)]">
          ...
          <CardContent className="space-y-5">
            ...
            <StreamSourceStep
              ...
              addAssetToEditor={addAssetToEditor}
              removeAssetFromEditor={removeAssetFromEditor}
        ...
        <StreamBuilderSummaryRail
          ...
          canLaunch={canLaunch}
          handleBuilderSubmit={handleBuilderSubmit}
          isBuilderSubmitting={isBuilderSubmitting}
