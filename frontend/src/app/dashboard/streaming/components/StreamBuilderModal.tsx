            ...
            <TabsContent value="content" className="mt-4 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 rounded-xl border border-slate-200 bg-white/80 p-4 dark:border-slate-700 dark:bg-slate-900/60">
                  ...
                  <div className="max-h-80 space-y-2 overflow-y-auto rounded-lg border border-slate-200 bg-white/70 p-3 dark:border-slate-700 dark:bg-slate-900/50">
                    {isLoadingAssets ? (
                                  ...
                                  >
                                    ...
                                    {draggable && (
                                      <Button
                                        variant="ghost"
                                        size="icon"
                                        onClick={() => removeAssetFromEditor('audio', item.asset_id)}
                                        aria-label={t('streams.liveEdit.actions.remove')}
                                      >
                                        <X className="h-4 w-4" />
                                      </Button>
