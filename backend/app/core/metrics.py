...
class AppMetrics:
    ...
    stream_starts = metrics_registry.counter(
        "stream_starts_total", "Total number of stream starts"
    )

    stream_stops = metrics_registry.counter(
        "stream_stops_total", "Total number of stream stops"
    )

    stream_errors = metrics_registry.counter(
        "stream_errors_total", "Total number of stream errors"
    )
    ...
    stream_duration = metrics_registry.histogram(
        "stream_duration_seconds", "Stream duration in seconds"
    )
    ...
    quota_denied = metrics_registry.counter(
        "quota_denied_total", "Total number of quota denials"
    )
    ...
    uploads_started = metrics_registry.counter(
        "uploads_started_total", "Total number of uploads started"
    )

    uploads_completed = metrics_registry.counter(
        "uploads_completed_total", "Total number of uploads completed"
    )

    uploads_failed = metrics_registry.counter(
        "uploads_failed_total", "Total number of uploads failed"
    )

    # Validation metrics
    validator_success = metrics_registry.counter(
        "validator_success_total", "Total number of successful validations"
    )

    validator_failed = metrics_registry.counter(
        "validator_failed_total", "Total number of failed validations"
    )

    # Admin metrics
    admin_actions = metrics_registry.counter(
        "admin_actions_total", "Total number of admin actions"
    )
