...
12. Під час host-native backend lane `frontend` і `tusd` мають бути перепідняті на upstream `http://host.docker.internal:8000`; helper-и вже роблять це автоматично.
